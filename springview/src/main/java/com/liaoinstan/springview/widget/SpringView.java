...
//    private boolean _i1sOverlap;             //保存用户动态设置样式时传入的参数
    ...
    public void setShowView(View view, ViewSwitchListener viewSwitchListener){
        this.mView=view;
...
//        return false;
    ...
    public void computeScroll() {
        ...
        if (mView != null && contentView != null && viewSwitchListener != null) {
            int y = contentView.getScrollY();
            if (isFlag) {
...
//                    ((ListView) contentView).smoothScrollBy(-1,0);
     ...
     * 是否禁用SpringView
     */
    public void setSpringViewEnable(boolean enable) {
        this.enable = enable;
    }
